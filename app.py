...
consumer_key = 'uwkwatLrBxpFYJFhSyFr6Buwx'
consumer_secret = '3kpN7OClLvYCanDf5CIXmKghsQc5hVOaCmYsd3x5rUOrPgiMJZ'
access_token = '2394030978-V7LEMC2ffA5CAAQpudxhfnZ2xoDgxl8lLrXnOuQ'
access_token_secret = 'ShbA8JoyfsIKhdxueLrPnwOgfRLPtJQBGUrurbQXYedXu'
...
CRYPTOCOMPARE_API_KEY = "ea7a2e93db9b297dd2077635fcb2c6f83cceb15ba26c72d88aa80b4d6647adda"
...
def result():
    ...
    r = requests.get(f'https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest', headers={'X-CMC_PRO_API_KEY': 'e8e13565-07c1-4e19-8f12-09e7a2b0ee99'}, params={'symbol': 'BTC', 'convert': currency})
    data = r.json()
